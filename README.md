...
Raspberry Pi Based Scada System is a hands-on course focused on practical Raspberry Pi
...
- Understand the core goals of the **Raspberry Pi Based Scada System** lessons.
...
sensors/actuators described in the Raspberry Pi Based Scada System videos, jumper wires,
...
# Or upload via Arduino IDE to replicate the Raspberry Pi Based Scada System lab
```
